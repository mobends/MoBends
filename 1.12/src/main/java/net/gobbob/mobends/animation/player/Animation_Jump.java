...
public class Animation_Jump extends Animation{
	...
	public void animate(EntityLivingBase argEntity, ModelBase argModel, EntityData argData) {
		...
		((ModelRendererBends)model.bipedRightArm).rotation.setSmooth(new Vector3f(0.0F, 0.0F, 0.0F),0.5f);
		...
		((ModelRendererBends)model.bipedLeftArm).rotation.setSmooth(new Vector3f(0.0F, 0.0F, 0.0F),0.5f);
