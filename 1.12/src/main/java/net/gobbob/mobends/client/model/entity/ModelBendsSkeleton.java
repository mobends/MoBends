...
public class ModelBendsSkeleton extends ModelBiped implements IBendsModel
{
    ...
    protected ModelBendsSkeleton(float scaleFactor, float p_i1167_2_, int textureWidth, int textureHeight)
    {
        ...
        ((ModelPart)this.bipedRightArm).offsetBoxBy(-0.01f, 0, -0.01f).resizeBox(2.02f, 6.0f, 2.02f).updateVertices();
        ((ModelPart)this.bipedLeftArm).offsetBoxBy(-0.01f, 0, -0.01f).resizeBox(2.02f, 6.0f, 2.02f).updateVertices();
