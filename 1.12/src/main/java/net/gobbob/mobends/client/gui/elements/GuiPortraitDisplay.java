...
public class GuiPortraitDisplay {
	...
	public void display(float partialTicks) {
		...
		fontRenderer.drawString(displayText, x+width/2-fontRenderer.getStringWidth(displayText)/2,(int) (y+height-smoothAnimation*10), 0xffffff);
	...
	public void renderLivingEntity(int argX, int argY, float scale, EntityLivingBase entityLivingBase)
    {
        ...
        GL11.glRotated(rotation, 0.0F, 1.0F, 0.0F);
