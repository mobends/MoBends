 ...
 * Run with `gradle generateVanillaFields`.
 */

private const val AT_BEGIN = "# --- generated by generateVanillaFields (src/tools), do not edit below ---"
...
fun main(args: Array<String>)
{
    ...
    writeJava(File(java, "VanillaModelParts.java"), "Function<Object, Object>", "m", parts,
    ...
    writeJava(File(java, "VanillaEntityFields.java"), "ToDoubleFunction<Object>", "e", numbers,
    ...
    writeAccessTransformer(File(project, "src/main/resources/META-INF/accesstransformer.cfg"), parts + numbers)
...
private fun writeJava(file: File, accessor: String, argument: String, fields: List<Found>, doc: String, import: String)
{
...
private fun writeAccessTransformer(file: File, fields: List<Found>)
{
    ...
    file.writeText((listOf(manual, "", AT_BEGIN) + generated).joinToString("\n") + "\n")
}
