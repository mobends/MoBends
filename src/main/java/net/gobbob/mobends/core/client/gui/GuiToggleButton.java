	...
	public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_, float partialTicks)
    {
        if (this.visible)
        {
            ...
            GL11.glPushMatrix();
	        	...
	        	this.drawTexturedModalRect(this.x - this.titleWidth, this.y, 0, 46 + k * 20, (this.titleWidth+this.width) / 2, this.height);
	        	this.drawTexturedModalRect(this.x + this.titleWidth / 2 - this.titleWidth, this.y, 200 - (this.titleWidth+this.width) / 2, 46 + k * 20, (this.titleWidth+this.width) / 2, this.height);
	        GL11.glPopMatrix();
            ...
            GL11.glPushMatrix();
            	...
            	this.drawTexturedModalRect(this.titleWidth + this.x - this.titleWidth, this.y, 0, 46 + k * 20, this.width / 2, this.height);
            	this.drawTexturedModalRect(this.titleWidth + this.x + this.width / 2 - this.titleWidth, this.y, 200 - this.width / 2, 46 + k * 20, this.width / 2, this.height);
            GL11.glPopMatrix();
            ...
            this.drawString(fontrenderer, this.title, this.x + 15  - this.titleWidth, this.y + (this.height - 8) / 2, l);
