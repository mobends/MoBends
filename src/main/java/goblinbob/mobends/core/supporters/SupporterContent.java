...
public class SupporterContent {
    ...
    > accessorySettingsPerPlayer = new HashMap<>();
    ...
    public static void fetchAccessoryDetails() {
        try {
            AccessoryDetailsResponse response = sendGetRequest(
                new URL(INSTANCE.apiUrl + "/api/accessory/details"),
                new HashMap<>(),
                AccessoryDetailsResponse.class
            );

            Map<String, AccessoryDetails> details = Objects.requireNonNull(
                response
            ).getDetails();
    ...
    public static void registerPlayerAccessorySettings(
        String playerName,
    ...
    public static Set<Map.Entry<String, AccessoryDetails>> getAccessories() {
        return Collections.unmodifiableSet(
            INSTANCE.accessoryDetailsMap.entrySet()
        );
    }

    public static Map<String, AccessorySettings> getAccessorySettingsMapFor(
    ...
    public static IColorRead getTrailColorFor(EntityLivingBase entity) {
        Map<String, AccessorySettings> settingsMap = getAccessorySettingsMapFor(
            entity
        );
