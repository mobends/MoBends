...
public class ModelBendsPlayer extends ModelPlayer implements IBendsModel
{
	...
	public boolean isRenderedInGui() {
		return DataUpdateHandler.renderingGuiScreen;
	}
	...
	public void setInvisible(boolean invisible)
    {
        ...
        this.bipedRightForeArmwear.showModel = invisible;
        this.bipedLeftForeArmwear.showModel = invisible;
        this.bipedRightForeLegwear.showModel = invisible;
        this.bipedLeftForeLegwear.showModel = invisible;
        
        this.bipedCloak.showModel = invisible;
        this.bipedEars.showModel = invisible;
    }
