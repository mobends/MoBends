...
public class GuiAnimationSection {
	...
	public int display(int x, int y, int mouseX, int mouseY) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(getAnimationName(), x+5,y+3, 0xffffff);
	...
	public void setAnimationName(String animationName) {
		...
		this.width = Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.animationName)+7;
	}
