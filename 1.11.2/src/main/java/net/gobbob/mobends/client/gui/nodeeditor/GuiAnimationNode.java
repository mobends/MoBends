...
public class GuiAnimationNode {
	...
	public int display(int x, int y) {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(getModel(), x+20,y+3, 0xffffff);
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(getAxisString(), x+16+3+width+18,y+3, 0xffffff);
        ...
        if(modifier != null) {
            ...
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(getModifier().name(), x+width+56,y+3, 0xffffff);
        }
	...
	public void setModel(String model) {
		this.model = model;
		this.width = Minecraft.getMinecraft().fontRendererObj.getStringWidth(model)+5;
		this.updateAddNodeX();
	}
	...
	public void setModifier(EnumModifier modifier) {
		...
		if(modifier != null) this.modifierWidth = Minecraft.getMinecraft().fontRendererObj.getStringWidth(modifier.name())+7;
		updateAddNodeX();
	}
