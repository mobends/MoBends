    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
		...
		GL11.glPushMatrix();
    		...
    		*/GL11.glColor4f(1,1,1,1.0f);
    		this.client.fontRendererObj.drawString(displayName,(int)(this.moBendsMenuGui.width-250+10)+5,y+5, 0xffffff);
    		
    		GL11.glPushMatrix();
    			GL11.glTranslatef((int)(this.moBendsMenuGui.width-250+10)+5,y+5+10,0);
