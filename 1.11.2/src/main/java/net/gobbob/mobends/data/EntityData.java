...
public abstract class EntityData {
	...
	public boolean calcOnGround(){
        ...
        List list = entity.world.getCollisionBoxes(entity, entity.getEntityBoundingBox().addCoord(0,-0.001f,0));
	...
	public boolean calcCollidedHorizontally(){
        ...
        List list = entity.world.getCollisionBoxes(entity, entity.getEntityBoundingBox().addCoord(this.motion.x,0,this.motion.z));
