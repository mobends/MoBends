...
public class BendsPack {
	...
	public static void animate(ModelBendsPlayer model,String target,String anim){
		BendsTarget bTarget = getTargetByID(target);
		
		if(bTarget == null)
			return;
		
		bTarget.applyToModel((ModelRendererBends) model.bipedBody, anim, "body");
		bTarget.applyToModel((ModelRendererBends) model.bipedHead, anim, "head");
		bTarget.applyToModel((ModelRendererBends) model.bipedLeftArm, anim, "leftArm");
		bTarget.applyToModel((ModelRendererBends) model.bipedRightArm, anim, "rightArm");
		bTarget.applyToModel((ModelRendererBends) model.bipedLeftLeg, anim, "leftLeg");
		bTarget.applyToModel((ModelRendererBends) model.bipedRightLeg, anim, "rightLeg");
		bTarget.applyToModel((ModelRendererBends) model.bipedLeftForeArm, anim, "leftForeArm");
		bTarget.applyToModel((ModelRendererBends) model.bipedRightForeArm, anim, "rightForeArm");
		bTarget.applyToModel((ModelRendererBends) model.bipedLeftForeLeg, anim, "leftForeLeg");
		bTarget.applyToModel((ModelRendererBends) model.bipedRightForeLeg, anim, "rightForeLeg");
		
		bTarget.applyToModel(model.renderRightItemRotation, anim, "rightItemRotation");
		bTarget.applyToModel(model.renderLeftItemRotation, anim, "leftItemRotation");
		bTarget.applyToModel(model.renderRotation, anim, "playerRotation");
	}
	...
	public static void animate(ModelBendsZombieVillager model,String target,String anim){
		BendsTarget bTarget = getTargetByID(target);
