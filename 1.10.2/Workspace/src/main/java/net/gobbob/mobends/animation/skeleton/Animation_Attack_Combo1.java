...
public class Animation_Attack_Combo1 {
	public static void animate(EntitySkeleton skeleton,ModelBendsSkeleton model,Data_Skeleton data){
		...
		if(skeleton.getHeldItem(EnumHand.MAIN_HAND) != null){
			if(skeleton.getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemSword){
