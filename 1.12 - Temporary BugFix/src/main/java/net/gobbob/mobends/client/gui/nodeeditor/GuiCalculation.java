...
public class GuiCalculation {
	...
	public int display(int x, int y) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.displayedText, x+17,y+3, 0xffffff);
	...
	public void setDisplayedText(String arg0) {
		...
		this.width = Minecraft.getMinecraft().fontRenderer.getStringWidth(this.displayedText)+12;
	}
