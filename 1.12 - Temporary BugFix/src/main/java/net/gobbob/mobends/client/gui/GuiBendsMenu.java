...
public class GuiBendsMenu extends GuiScreen{
	...
	public void initGui()
    {
		...
		if(this.guiTab == TAB_CUSTOMIZE){
			if(PackManager.isCurrentPackLocal()) {
				...
				this.buttonList.add(new GuiButton(5, (width-fontRenderer.getStringWidth(buttonTitle)-20)/2, guiTop+150, fontRenderer.getStringWidth(buttonTitle)+20, 20, buttonTitle));
			}
		}
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	switch(guiTab) {
    		...
    		case TAB_SETTINGS:
        		...
        		this.drawString(this.fontRenderer, title, (int) (this.width/2-this.fontRenderer.getStringWidth(title)/2), 5, 0xffffff);
        		for(GuiSettingsNode node : settingsNodes){
	...
	public void displayCustomizeWindow(int mouseX, int mouseY, float partialTicks){
		...
		this.drawCenteredString(this.fontRenderer, I18n.format("mobends.gui.customize", new Object[0]), (int) (this.width/2), this.guiTop+4, 0xffffff);
		
		this.nodeEditor.display(mouseX, mouseY, partialTicks);
		if(!PackManager.isCurrentPackLocal()){
			this.drawCenteredString(fontRenderer, I18n.format("mobends.gui.chooseapacktoedit", new Object[0]), this.width/2, this.guiTop+135, 0xffffff);
		}
